...
const char* ei_classifier_inferencing_categories[] = { "activate", "alexa", "hey siri", "login", "open", "open the door", "shut down", "start", "thank you", "unlock", "verify", "welcome" };
...
ei_dsp_config_spectrogram_t ei_dsp_config_4 = {
    4, // uint32_t blockId
    4, // int implementationVersion
    1, // int length of axes
...
const uint8_t ei_dsp_blocks_size = 3;
...
const ei_config_tflite_eon_graph_t ei_config_graph_5 = {
...
const uint8_t ei_output_tensors_indices_5[1] = { 0 };
const uint8_t ei_output_tensors_size_5 = 1;
ei_learning_block_config_tflite_graph_t ei_learning_block_config_5 = {
    .implementation_version = 1,
    .block_id = 5,
    .output_tensors_indices = ei_output_tensors_indices_5,
    .output_tensors_size = ei_output_tensors_size_5,
    .quantized = 1,
    .compiled = 1,
    .graph_config = (void*)&ei_config_graph_5,
    .dequantize_output = 0,
};

const uint8_t ei_learning_blocks_size = 1;
const uint32_t ei_learning_block_5_inputs[3] = { 2,3,4 };
const uint8_t ei_learning_block_5_inputs_size = 3;
...
ei_fill_result_classification_i8_config_t ei_fill_result_classification_i8_config_5 = {
    .zero_point = -128,
    .scale = 0.00390625
};
...
const ei_postprocessing_block_t ei_postprocessing_blocks[ei_postprocessing_blocks_size] = {
    {
        ...
        .display_fn = NULL,
        .config = (void*)&ei_fill_result_classification_i8_config_5,
        .input_block_id = 5
    },
};

const ei_impulse_t impulse_764684_0 = {
    .project_id = 764684,
...
ei_impulse_handle_t impulse_handle_764684_0 = ei_impulse_handle_t( &impulse_764684_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_764684_0;
