/*
  Nano33BLESensorExample_colour.ino
  Copyright (c) 2020 Dale Giancono. All rights reserved..

  This program is an example program showing some of the cababilities of the 
  Nano33BLESensor Library. In this case it outputs colour data from one of 
...
#define BLE_LOCAL_NAME                "Colour BLE"

/*****************************************************************************/
/*GLOBAL Data                                                                */
/*****************************************************************************/
/* 
 * Nano33BLEColourData object which we will store data in each time we read 
 * the colour data. 
 */ 
...
BLECharacteristic colourBLE("000C", BLERead | BLENotify | BLEBroadcast, BLE_BUFFER_SIZES);
...
void setup()
{
    ...
    else
    {
        ...
        BLESensors.addCharacteristic(colourBLE);
