...
const char* ei_classifier_inferencing_categories[] = { "1", "2", "hello", "open the door" };

ei_dsp_named_axis_t ei_dsp_config_15_named_axes[] = {
    { .name = "Signal", .axis = 0 }
};
size_t ei_dsp_config_15_named_axes_size = 1;
EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_15_axes[] = { 0 };
const uint32_t ei_dsp_config_15_axes_size = 1;
ei_dsp_config_mfcc_t ei_dsp_config_15 = {
    15, // uint32_t blockId
    4, // int implementationVersion
    1, // int length of axes
    ei_dsp_config_15_named_axes, // named axes
    ei_dsp_config_15_named_axes_size, // size of the named axes array
    13, // int num_cepstral
...
EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_19_axes[] = { 0 };
...
ei_model_dsp_t ei_dsp_blocks[ei_dsp_blocks_size] = {
    { // DSP block 15
        ...
        (void*)&ei_dsp_config_15, // pointer to config struct
        ei_dsp_config_15_axes, // array of offsets into the input stream, one for each axis
        ei_dsp_config_15_axes_size, // number of axes
        1, // version
...
ei_learning_block_config_tflite_graph_t ei_learning_block_config_16 = {
    .implementation_version = 1,
...
const uint32_t ei_learning_block_16_inputs[2] = { 15,19 };
const uint8_t ei_learning_block_16_inputs_size = 2;
const ei_learning_block_t ei_learning_blocks[ei_learning_blocks_size] = {
    {
        ...
        ei_learning_block_16_inputs,
        ei_learning_block_16_inputs_size,
        4
    },
};
...
const ei_impulse_t impulse_751639_0 = {
    .project_id = 751639,
    .project_owner = "vijaykumar",
    .project_name = "MVMP-spotting",
    .impulse_id = 2,
    .impulse_name = "Impulse #2",
    .deploy_version = 1,

    .nn_input_frame_size = 663,
...
ei_impulse_handle_t impulse_handle_751639_0 = ei_impulse_handle_t( &impulse_751639_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_751639_0;
